...
const STORAGE_KEY_HOD = 'paupet_horarios_data_v2'; // v2: keys por fecha exacta YYYY-MM-DD
...
function HorariosPage() {
  ...
  // slots/tomados/diasActivos se indexan por fecha exacta "YYYY-MM-DD"
  // diasActivos guarda Set de fechas desactivadas (días en que "no trabajo")
  const [slots, setSlots] = useState(saved?.slots || {});
  const [diasActivos, setDiasActivos] = useState(saved?.diasActivos || []);   // array de fechas activas
  const [tomados, setTomados] = useState(saved?.tomados || {}); // {"YYYY-MM-DD": [hora, ...]}
    ...
    <section style={{width:'100%'}}>
      ...
      <div style={{marginBottom:20,display:'flex',alignItems:'flex-start',justifyContent:'space-between',flexWrap:'wrap',gap:12}}>
        ...
        <div style={{display:'flex',gap:10,flexWrap:'wrap'}}>
          <button onClick={()=>{
            // Limpia slots, tomados y dias-no-activos de la semana actual
          ...
          }} style={{background:'none',border:'1.5px solid #ede8e8',borderRadius:50,padding:'8px 16px',fontSize:12,cursor:'pointer',color:'#9a9090',fontFamily:"'Outfit',sans-serif"}}>🗑 Limpiar</button>
